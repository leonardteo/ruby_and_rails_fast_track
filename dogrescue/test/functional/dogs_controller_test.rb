...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { age: @dog.age, available: @dog.available, breed: @dog.breed, description: @dog.description, name: @dog.name }
    end
  ...
  test "should update dog" do
    put :update, id: @dog, dog: { age: @dog.age, available: @dog.available, breed: @dog.breed, description: @dog.description, name: @dog.name }
    assert_redirected_to dog_path(assigns(:dog))
  end
